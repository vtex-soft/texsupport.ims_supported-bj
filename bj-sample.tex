...
\author[B]{\inits{S.}\fnms{Second} \snm{Author}\ead[label=e2,mark]{second@somewhere.com}}
\and
\author[B]{\inits{T.}\fnms{Third} \snm{Author}\ead[label=e3,mark]{third@somewhere.com}\ead[label=u1,url]{www.foo.com}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Addresses                                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

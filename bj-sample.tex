...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author[A]{\inits{F.}\fnms{First}~\snm{Author}\thanks{[\textbf{Corresponding author indication should be put in the Acknowledgment section if necessary.}]}\ead[label=e1]{first@somewhere.com}}
\author[B]{\inits{S.}\fnms{Second}~\snm{Author}\ead[label=e2]{second@somewhere.com}\orcid{0000-0000-0000-0000}}
\author[B]{\inits{T.}\fnms{Third}~\snm{Author}\ead[label=e3]{third@somewhere.com}\ead[label=u1,url]{www.foo.com}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Addresses                                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\address[A]{Department,
University or Company Name, City, Country\printead[presep={,\ }]{e1}}

\address[B]{Department,
University or Company Name, City, Country\printead[presep={,\ }]{e2,e3,u1}}
\end{aug}
...
\end{tabular}
\begin{tabnotes}
\tabnotetext[id=tab1,mark=a]{This is the way to use table notes.}
\end{tabnotes}
\end{table*}
